...
import nwafu.cie.fastdoop.FASTQInputFileFormat;
 ...
 * 
 */
public class BigPerfRunner2 extends Configured implements Tool{
	@Override
	public int run(String[] args) throws Exception {
		...
		// Set main class
		job.setJarByClass(BigPerfRunner2.class);
		// Set mapreduce class
		job.setMapperClass(BigPerfMapper2.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new BigPerfRunner2(), args);
